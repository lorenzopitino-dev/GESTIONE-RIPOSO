    ...
    Component {
        ...
        Page {
            ...
            function calcolaBadge(riposi, mappaColleghi, oreStr, dettaglioStr) {
                ...
                var occorrenzeAnagrafe = contaOccorrenzeLicenzeSettimana(tuttiMese, ["MAT"])
                if (occorrenzeAnagrafe > 0)
                    candidati.push({ nome: "Ufficio anagrafe", livello: 1, colore: "#C0C0C0", occorrenze: occorrenzeAnagrafe })

                var occorrenzeVampiro = contaOccorrenzeLicenzeSettimana(tuttiMese, ["SER", "POM"])
            ...
            Connections {
                ...
                function onDettaglioStraordinariRicevuti(lista) {
                    ...
                    if (paginaMenu._attesaColleghi !== 0 || paginaMenu.listaRiposiRaw.length === 0) return
                    ...
                    Column {
                        ...
                        AnimatedImage {
                            ...
                            source: {
                                ...
                                if (b.nome === "Ufficio anagrafe")  return "https://media0.giphy.com/media/3o7TKTDn976rzVgky4/giphy.gif"
                                if (b.nome === "Il vampiro")        return "https://media2.giphy.com/media/PA5pAhOp5Y2Qg/giphy.gif"
